...
const baseProducts = [
  { name: 'Ração Premier para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1669836858199.jpg', category: 'DOGS' },
  { name: 'Ração Golden Special para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1658429301983.', category: 'DOGS' },
  { name: 'Moletom para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1647292785829.jpg', category: 'DOGS' },
  { name: 'Macacão para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1669738862596.jpg', category: 'DOGS' },
  { name: 'Moletom Marvel para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1662144115438.jpg', category: 'DOGS' },
  { name: 'Casaco para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1646770429643.jpg', category: 'DOGS' },
  { name: 'Bolinhas para cachorro', description: faker.lorem.paragraph(), image_url: 'https://images.petz.com.br/fotos/1582822321392.jpg', category: 'DOGS' },
